#!/usr/bin/env python3
"""Generate a maze-solving SFT dataset for `unsloth/Qwen3.5-4B`.

Thin model-specific entrypoint: uses the generic engine in
`scripts/dataset_gen.py` and the Qwen formatter in `qwen_format.py`, writing to
`data/qwen3.5/`.
...
from dataset_gen import cap_duplicates, run_sweep, write_dataset  # noqa: E402
from qwen_format import format_example, tool_schemas  # noqa: E402
