#!/usr/bin/env python3
"""Generate a maze-solving SFT dataset for `unsloth/Llama-3.2-1B-Instruct`.

Usage:
    python scripts/llama-3.2-1b/generate.py --sizes 5,6,7,8,9,10 --per-size 1000
    python scripts/llama-3.2-1b/generate.py --sizes 6 --per-size 3 --preview 2
