...
Llama-3.2-3B) against the D* Lite reference, over mazes none of them trained
on.
...
you want to compare in one run (e.g. the stock `llama3.2:3b` next to your
fine-tuned `llama-3.2-3b-maze`).
...
Usage:
    python scripts/llama-3.2-3b/eval.py \\
        --models llama3.2:3b,llama-3.2-3b-maze \\
...
def main():
    ...
    ap.add_argument("--models", required=True,
                     help="comma-separated Ollama model tags to compare, e.g. llama3.2:3b,llama-3.2-3b-maze")
